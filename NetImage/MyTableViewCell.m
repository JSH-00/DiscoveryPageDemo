...
//
//        UIImageView *hover_icon = [UIImageView new];
//        self.hoverImage = hover_icon;
//        [hover_icon setImage:[UIImage imageNamed:@"home_logo_base.png"]];
////        hover_icon.backgroundColor = [UIColor redColor];
//        [self.contentView addSubview:hover_icon];
//        [hover_icon mas_makeConstraints:^(MASConstraintMaker *make) {
//            make.size.mas_equalTo(CGSizeMake(36, 8));
//            //            make.top.equalTo(_bookImageView.mas_top).with.offset(169); //with is an optional semantic filler
//            make.left.equalTo(_bookImageView.mas_left).with.offset(12);
//            make.bottom.equalTo(_bookImageView.mas_bottom).with.offset(-12);
//            //            make.right.equalTo(_bookImageView.mas_right).with.offset(-17);
//        }];
